...
const TENANT_SEEDS = [
    ...
    },
    {
        ...
        name: "C 公司",
        phone: "07-3311-0003",
        address: "高雄市前鎮區測試路 303 號",
        paymentInfo: "現金 / LINE Pay",
        subscriptionAmount: 1999,
        subscriptionStartDaysAgo: 5,
        admin: {
            staffMemberId: "staff_admin_c",
            email: "adminc@gmail.com",
            password: DEMO_PASSWORD,
            displayName: "C Company Admin",
            name: "C 公司管理員",
        },
        customer: {
            customerId: "cx_c",
            ...
            name: "C 客戶",
            phone: "0911000003",
            address: "高雄市鳳山區試營路 3 號",
        },
        ticket: {
            id: "ticket_c_001",
            title: "C 客戶 - Google Pixel 8",
            status: "new",
            quoteStatus: "inspection_estimate",
            deviceName: "Google Pixel",
            deviceModel: "8",
            repairReason: "無法開機與充電異常",
            repairSuggestion: "先檢測電源管理與連接埠",
            note: "Phase 2 seed baseline (company C)",
            repairAmount: 3200,
            inspectionFee: 250,
        },
        sale: {
